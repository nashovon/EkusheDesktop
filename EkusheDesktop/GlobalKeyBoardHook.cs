    ...
    public class GlobalKeyboardHook
    {
        ...
        public int HookProc(int Code, int wParam, ref keyBoardHookStruct lParam)
        {
            if (Code >= 0)
            {
                ...
                if ((lParam.vkCode >= 65 && lParam.vkCode <= 90) || lParam.vkCode == 160 || lParam.vkCode == 32 || lParam.vkCode == 8 || (lParam.vkCode >= 96 && lParam.vkCode <= 105) || (lParam.vkCode >= 48 && lParam.vkCode <= 57))
                {
                    //SendKeys.Send("আ");
